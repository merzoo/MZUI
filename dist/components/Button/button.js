...
export var Button = function (props) {
    var _a;
    var btnType = props.btnType, disabled = props.disabled, size = props.size, href = props.href, children = props.children, className = props.className, restProps = __rest(props, ["btnType", "disabled", "size", "href", "children", "className"]);
